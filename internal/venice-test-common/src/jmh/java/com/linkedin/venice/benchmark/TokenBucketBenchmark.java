...
public class TokenBucketBenchmark {
  ...
  @Benchmark
  @Threads(16)
  public void tokenBucketWithThreadCount16(ThreadContext threadContext, Blackhole bh) {
    test(threadContext, bh);
  }

  @Benchmark
  @Threads(32)
  public void tokenBucketWithThreadCount32(ThreadContext threadContext, Blackhole bh) {
    test(threadContext, bh);
  }

  @Benchmark
  @Threads(64)
  public void tokenBucketWithThreadCount64(ThreadContext threadContext, Blackhole bh) {
    test(threadContext, bh);
  }
